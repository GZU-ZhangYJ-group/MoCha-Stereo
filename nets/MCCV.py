...
class Mca_Camp(nn.Module):
    def __init__(self):
        ...
        laten_chans = [4,4,4,4]
        self.sw_4x = nn.Conv2d(chans[0],laten_chans[0], 3, 1, 1, bias=False)
        self.sw_8x = nn.Conv2d(chans[1],laten_chans[1], 3, 1, 1, bias=False)
        self.sw_16x = nn.Conv2d(chans[2],laten_chans[2], 3, 1, 1, bias=False)
    ...
    def forward(self, normal_feature):
        ...
        channel_correlation_volume_32x = normal_feature[3]
        return [channel_correlation_volume_4x, channel_correlation_volume_8x, channel_correlation_volume_16x, channel_correlation_volume_32x]
